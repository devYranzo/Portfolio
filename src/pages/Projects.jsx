  ...
  return (
    <PageWrapper>
      <div className="flex flex-col items-center font-Montserrat">
        ...
        <article className="grid lg:grid-cols-2 xl:grid-cols-3 gap-8 mx-[8.33%]">
          {projects.map((project) => (
            <div
              key={project.id}
              className="group flex-col rounded-xl shadow-lg max-w-[370px] max-h-[500px] bg-transparent backdrop-blur-md border border-stone-900 m-4 overflow-hidden"
            >
              <img
                src={project.image}
